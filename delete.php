<?php 
	...
	if(isset($_POST["action"])&&($_POST["action"]=="delete")){	
		$sql_query = "DELETE FROM order1 WHERE cNumber=?";
...
<form action="" method="post" name="formDel" id="formDel">
  <table border="1" align="center" cellpadding="4">
    ...
    <tr>
      <td>取餐日期</td><td><?php echo $Date;?></td>
    </tr>
    <tr>
      <td>取餐時間</td><td><?php echo $Time;?></td>
    </tr>
    <tr>
      <td>外送地址</td><td><?php echo $Address;?></td>
    </tr>
    <tr>
      <td>電子郵件</td><td><?php echo $Mail;?></td>
    </tr>
    <tr>
      <td>餐點名稱</td><td><?php echo $Meals;?></td>
    </tr>
    <tr>
      <td>飯量</td><td><?php echo $Size;?></td>
    </tr>
    <tr>
      <td>滷汁</td><td><?php echo $Marinade;?></td>
    </tr>
    <tr>
      <td>加料</td><td><?php echo $Ad;?></td>
    </tr>
    <tr>
      <td>加辣</td><td><?php echo $Spicy;?></td>
    </tr>
    <tr>
      <td>是否要切</td><td><?php echo $Cut;?></td>
    </tr>
    <tr>
