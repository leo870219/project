...
if (isset($_POST["action"]) && ($_POST["action"] == "update")) {
  $sql_query = "UPDATE odlist SET Name=?,Phone=?,Takeway=?,Date=?,Time=?,Address=?,Mail=?,Meals=?,Size=?,Marinade=?,Ad=?,Spicy=?,Cut=?,Amount=?,Total=? WHERE cNumber=?";
...
$sql_select = "SELECT cNumber, Name, Phone, Takeway, Date, Time, Address, Mail, Meals,Size,Marinade,Ad,Spicy,Cut,Amount,Total FROM odlist WHERE cNumber = ?";
...
<body>
  ...
  <form action="" method="post" name="formFix" id="formFix">
    <table border="1" align="center" cellpadding="4">
      ...
      <tr>
        <td>餐點名稱</td>
        <td><input type="text" name="Meals" id="Meals" value="<?php echo $Meals; ?>"></td>
      </tr>
      <tr>
        <td>飯量</td>
      ...
      <tr>
        <td>滷汁</td>
        <td><input type="text" name="Marinade" id="Marinade" value="<?php echo $Marinade; ?>"></td>
      </tr>
      <tr>
        <td>加料</td>
        <td><input type="text" name="Ad" id="Ad" value="<?php echo $Ad; ?>"></td>
      </tr>
      <tr>
        <td>加辣</td>
        <td><input type="text" name="Spicy" id="Spicy" value="<?php echo $Spicy; ?>"></td>
      </tr>
      <tr>
        <td>是否要切</td>
        <td><input type="text" name="Cut" id="Cut" value="<?php echo $Cut ?>"></td>
      </tr>
      <tr>
        <td>數量</td>
      ...
      <tr>
        <td>總金額</td>
        <td><input type="text" name="Total" id="Total" value="<?php echo $Total; ?>"></td>
      </tr>
      <tr>
