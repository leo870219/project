...
if (isset($_POST["action"]) && ($_POST["action"] == "add")) {
  ...
  $sql_query = "INSERT INTO odlist (Name,Phone,Takeway,Date,Time,Address,Mail,Meals,Size,Marinade,Ad,Spicy,Cut,Amount,Total)VALUES (?, ?, ?, ? ,? ,?, ?, ?, ? ,? ,?,?,?,?,?)";
...
<body>
  ...
  <form action="" method="post" name="formAdd" id="formAdd">
    <table border="1" align="center" cellpadding="4">
      ...
      <tr>
        <td>餐點名稱</td>
        <td><input type="text" name="Meals" id="Meals"></td>
      </tr>
      <tr>
        <td>飯量</td>
      ...
      <tr>
        <td>滷汁</td>
        <td><input type="text" name="Marinade" id="Marinade"></td>
      </tr>
      <tr>
        <td>加料</td>
      ...
      <tr>
        <td>加辣</td>
        <td><input type="text" name="Spicy" id="Spicy"></td>
      </tr>
      <tr>
        <td>是否要切</td>
        <td><input type="text" name="Cut" id="Cut"></td>
      </tr>
      <tr>
        <td>數量</td>
